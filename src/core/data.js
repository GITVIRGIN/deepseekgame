...
export const cards = {
  ...
  battleSurge: {
    ...
    rarity: "rare",
    cost: 0,
    text: "获得 4 层杀意（每层 +3 物理伤害，回合末 -1 层）。",
    mythTags: ["人间"],
    style: "physical",
    grade: 2,
    effects: [{ type: "status", target: "self", status: "fury", stacks: 4 }],
  },
  soulSever: {
    id: "soulSever",
    name: "斩魂式",
    rarity: "legendary",
    cost: 3,
    text: "若敌人生命 ≤25% 则直接斩杀（无视格挡）；否则造成 25 点伤害。",
    mythTags: ["幽冥"],
    style: "physical",
    grade: 3,
  ...
  fiveThunder: {
    ...
    rarity: "epic",
    cost: 2,
    text: "造成 18 点伤害，抽 1 张牌，获得 1 点能量和 2 层雷印。",
    mythTags: ["天庭"],
    style: "spell",
    grade: 3,
    effects: [
  ...
  bloodNet: {
    ...
    rarity: "rare",
    cost: 1,
    text: "失去 2 点生命。对所有敌人施加 5 层流血，汲取其流血回复生命（×0.2）。",
    mythTags: ["幽冥"],
    style: "bleed",
    grade: 2,
    effects: [
      { type: "loseHp", target: "self", value: 2 },
      { type: "status", target: "allEnemies", status: "bleed", stacks: 5 },
      { type: "leechBleed", target: "allEnemies", value: 0.2 },
    ],
  },
  bloodRiver: {
    id: "bloodRiver",
  ...
  asuraBlood: {
    ...
    rarity: "legendary",
    cost: 2,
    text: "失去 6 点生命。对所有敌人造成 10 点伤害，施加 12 层流血，汲取其流血回复生命（×0.4）。",
    mythTags: ["幽冥"],
    style: "bleed",
    grade: 3,
    effects: [
      ...
      { type: "leechBleed", target: "allEnemies", value: 0.4 },
    ],
  },
  poisonPowder: {
    id: "poisonPowder",
  ...
  chainLightning: {
    ...
    rarity: "rare",
    cost: 1,
    text: "对所有敌人造成 4 点伤害，施加 2 层雷印。",
    mythTags: ["天庭"],
    style: "spell",
    grade: 2,
    effects: [
      { type: "damage", target: "allEnemies", value: 4 },
      { type: "status", target: "allEnemies", status: "thunderMark", stacks: 2 },
    ],
  },
  heavenThunder: {
    id: "heavenThunder",
    ...
    rarity: "epic",
    cost: 2,
    text: "造成 10 点伤害，施加 3 层雷印，获得 1 点灵气。",
    mythTags: ["天庭"],
    style: "spell",
    grade: 3,
    effects: [
      { type: "damage", target: "enemy", value: 10 },
      { type: "status", target: "enemy", status: "thunderMark", stacks: 3 },
      { type: "status", target: "self", status: "spirit", stacks: 1 },
    ],
  },
  gatherAsh: {
